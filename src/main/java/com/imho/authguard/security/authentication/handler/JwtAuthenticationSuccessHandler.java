...
public class JwtAuthenticationSuccessHandler implements AuthenticationSuccessHandler {
    ...
    public void onAuthenticationSuccess(HttpServletRequest request, HttpServletResponse response, Authentication authentication) throws IOException, ServletException {
        ...
        // Create access and refresh tokens for the authenticated user, including access token expiration timestamps
        Map<String, String> body = jwtUtil.generateTokens(user);

        writeJsonResponse(response, body, HttpServletResponse.SC_OK);
    }
